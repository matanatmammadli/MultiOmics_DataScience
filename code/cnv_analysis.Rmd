...
#"01" "11" "06"
unique(types)
samples <- unique(gsub("-[0-9A-Z]*-[0-9A-Z]*-[0-9A-Z]*-01$", "", CN[,1]))
...
################################################################
```
REF: https://academic.oup.com/bioinformatics/article/27/21/2949/216716
```{r}
require(gaia)
...
```
dim(markersMatrix_fil) is 1823588 3, -> it has 2millions CNV
dim(cnvMatrix)
[1] 79611     6
```{r}
#Prepare CNV matrix
...
```{r}
gaiaCNVplot(RecCNV, threshold=0.05,)
```
