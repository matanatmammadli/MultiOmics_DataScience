...
```{r}
clin_stage <- read.csv("/Users/matanatmammadli/Desktop/MultiOmic_Datascience-main/results/gene_exp_analysis/clinical.csv",header=TRUE,sep="\t")
raw_count <- read.csv("/Users/matanatmammadli/Desktop/MultiOmic_Datascience-main/results/gene_exp_analysis/count_data.csv",header=TRUE,sep = "\t")
```
